...
class DailiesControllerTest < ActionController::TestCase
  ...
  test "should create daily" do
    assert_difference('Daily.count') do
      post :create, daily: { completed: @daily.completed, completed_by: @daily.completed_by, title: @daily.title }
    end
  ...
  test "should update daily" do
    patch :update, id: @daily, daily: { completed: @daily.completed, completed_by: @daily.completed_by, title: @daily.title }
    assert_redirected_to daily_path(assigns(:daily))
  end
