...
class WeeksControllerTest < ActionController::TestCase
  ...
  test "should create week" do
    assert_difference('Week.count') do
      post :create, week: { completed: @week.completed, completed_by: @week.completed_by, title: @week.title }
    end
  ...
  test "should update week" do
    patch :update, id: @week, week: { completed: @week.completed, completed_by: @week.completed_by, title: @week.title }
    assert_redirected_to week_path(assigns(:week))
  end
