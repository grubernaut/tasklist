...
class MonthsControllerTest < ActionController::TestCase
  ...
  test "should create month" do
    assert_difference('Month.count') do
      post :create, month: { completed: @month.completed, completed_by: @month.completed_by, title: @month.title }
    end
  ...
  test "should update month" do
    patch :update, id: @month, month: { completed: @month.completed, completed_by: @month.completed_by, title: @month.title }
    assert_redirected_to month_path(assigns(:month))
  end
